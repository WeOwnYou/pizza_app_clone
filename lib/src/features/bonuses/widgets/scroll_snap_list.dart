...
class ScrollSnapListState extends State<ScrollSnapList> {
  ...
  double calculateScale(int index) {
    ...
    //default equation
    return 1 - min(difference.abs() / 800, 0.2);
  }
  ...
  double _calcCardLocation(
    ...
    //subtracted by itemSize/2 (to center the item)
          ...
          return GestureDetector(
            ...
            child: NotificationListener<ScrollNotification>(
              onNotification: (scrollInfo) {
                ...
                //Try to avoid infinite animation loop caused by multi-level NotificationListener
                ...
                if (scrollInfo is ScrollEndNotification) {
                  ...
                  if (widget.updateOnScroll??false) {
                    // dont snap until after first drag
                    if (isInit) {
                      return true;
                    }
